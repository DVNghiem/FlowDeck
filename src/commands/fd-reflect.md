...
1. Read recent session artifacts from `.codebase/DECISIONS.jsonl`, `.codebase/FAILURES.json`, `.codebase/RUNS.jsonl`, and `~/.fd-plan/<slug>/STATE.md` to generate the reflection context.
